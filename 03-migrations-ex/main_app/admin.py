...
# •	The fields of the model - name, email, and phone should be displayed as columns.
# •	Filter the model fields by name, and phone.
# •	Search the model’s records by email, contact_person, and phone.
# •	Objects list per page - 20. ?
# •	Organize the fields of the model into one section:
#  "Information" consists of four fields - name, contact_person, email and address.
