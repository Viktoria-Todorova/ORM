...
from main_app.choices import LaptopChoices, OperationSystemChoices, MealTypeChoices, WorkoutTypeChoices
...
class Laptop(models.Model):
    ...
    brand=models.CharField(max_length=20,choices=LaptopChoices)
