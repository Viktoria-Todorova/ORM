    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(max_length=15, unique=True, validators=[main_app.validators.PhoneNumberValidator()])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spacecraft', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='missions_spacecraft', to='main_app.spacecraft')),
            ],
            options={
                'abstract': False,
            },
